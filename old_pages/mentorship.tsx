import {
  ...
  RegistrationData,
  RegistrationType
} from '@/Components/Forms/MentoringForm';
...
const MentorshipPage: NextPage = () => {
  ...
  const [existingRegistrationType, setRegistrationStatus] =
  ...
  return (
    <>
      <Typography variant='h3' textAlign='center'>
        GLA Summit 2022 Mentorship Scheme
      </Typography>
      <Box width={{ xs: '90%', sm: '60%' }} mx='auto'>
        <P py={1}>
          <P fontStyle='italic' textAlign='center'>
            &ldquo;memorable events are built around ideas, not
            individuals&rdquo;
          </P>
          and so that&apos;s why this year we&apos;re inviting community leaders
          to mentor new presenters, by helping them develop their ideas and
          present them at the GLA Summit 2022.
        </P>

        <P py={1}>
          This initiative is about encouraging those have something to say, but
          don&apos;t necessarily feel confident presenting in front of the
          LabVIEW and TestStand Community [just yet].
        </P>
        ...
        <Box py={1}>
          ...
          <List>
            <ListItem sx={{ py: 0 }}>
              ...
              <Typography>
                An initial meeting with the mentee discuss initial ideas. The
                mentor can suggest what does and doesn&apos;t works well with
                audiences.
              </Typography>
            </ListItem>
            <ListItem sx={{ py: 0 }}>
        ...
        <P>
          If you&apos;re up for mentoring a new wave of speakers, let us know by
          filling out the form below with the &ldquo;I&apos;d like to be a
          mentor!&rdquo; element selected
        </P>

        <P>
          Equally, if you&apos;d like guidance on your presentation, select the
          &ldquo;I&apos;d like to receive mentorship&rdquo; form and click
          submit!
        </P>
