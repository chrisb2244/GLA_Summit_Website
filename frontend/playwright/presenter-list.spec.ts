...
test.describe('Presenter-list tests', () => {
  ...
  test(
    'presenter list matches the visual baseline',
    { tag: '@regression' },
    async ({ page }) => {
      await page.goto('/presenter-list/2024');
      await expect(page).toHaveScreenshot('presenter-list.png', {
        fullPage: true,
