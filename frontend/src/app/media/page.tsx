...
const MediaPage = () => {
  ...
  const SidewaysBox = (props: { children?: ReactNode }) => {
    return (
      <div className='flex items-center flex-col sm:flex-row px-8 max-sm:space-y-2 sm:space-x-2'>
        {props.children}
      </div>
    )
  }
  ...
  const jkiDiv = (
    <SidewaysBox>
      ...
      <p className='mx-2 w-full flex-grow prose max-w-none'>
  ...
  const signatureDiv = (
    <SidewaysBox>
      <div className='relative h-[10vw] w-full max-h-[200px]'>
        <NextImage
          src={SignatureImage}
      ...
      <div className='p-6 bg-gray-200'>
          <code className='max-xl:break-all font-mono'>
